...
{ grid=Ext.create('Ext.grid.Panel',{
	...
	columns:[
	         ...
	         {text: "短信发送ID", width: 120, dataIndex: 'srcId', sortable: true,
	        	 renderer :function(v) {  
	        	 return "<a href='#' onclick='look_btn()'><span style='font-weight:700'>"+v+"</span></a>";
	         }},
	         ...
	         {text: "发送状态", width: 120, dataIndex: 'status', sortable: true,
	        	 editor : {  
	        	 allowBlank : false  
	         },
	         renderer:function(v,b){
	        	    if(v==0){                                                // 判断值类型
	                     return "<span style='color:green'>成功</span>";   // 改变输出字体颜色
	                }else if(v==1){
	                      return "<span style='color:red'>失败</span>";
	                }else if(v==2){
	                      return "<span style='color:#DC143C'>已读</span>";
	                }else if(v==3){
	                      return "<span style='color:blue'>发送中</span>";
	                }else{
	                      return "<span style='color:gray'>未知</span>";
	                }
	             }
	         }, 
	         {text: "单发/组发", width: 120, dataIndex: 'IG', sortable: true,
	        	 editor : {  
	        	 allowBlank : false  
	         },    
	         renderer:function(v,b){
	        	    if(v==0){                                                // 判断值类型
	                    //cellmeta.css="reportColor4";     // 设置样式
	                     return "<span style='color:green'>单发</span>";   // 改变输出字体颜色
	                }else if(v==1){
	                      //cellmeta.css="reportColor5";
	                      return "<span style='color:red'>组发</span>";
	                }else{
	                      return "<span style='color:blue'>未知</span>";
	                }
	             }}, 
	         /*{text: "流水号", width: 80, dataIndex: 'serNum', sortable: false,
	        	 editor : {  
	        	 allowBlank : false  
	         }},*/ 
