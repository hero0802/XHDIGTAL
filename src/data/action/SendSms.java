...
public class SendSms extends ActionSupport{
	...
	{
		String sql ="",sql2=""; 
		sql2="select count(id) from xhdigital_sendsms where srcId like '"+srcId+"%' and dstId like '"+dstId+"%'" +
		...
		{           
			sql="select * from xhdigital_sendsms where srcId like '"+srcId+"%' and dstId like '"+dstId+"%'" +
				" and writeTime>='"+Ftime+"' and writeTime<='"+Etime+"' " +
